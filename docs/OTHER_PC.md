...
(다 치워도 93.3GB, 받는 도중 최대치가 **170~250GB** — 디스크 전체 237.8GB
보다 커서 여유의 문제가 아닙니다. 근거는
[`docs/results/AIHUBSHELL_피크_실측.md`](results/AIHUBSHELL_피크_실측.md)).
...
| 디스크 여유 | **250GB** (TL02 기준). 90GB 는 크롭이 끝난 **뒤** 남는 양이고,
받는 도중엔 aihubshell 이 `download.tar` + 조각 + 합친 파일을 겹쳐 놓습니다 —
`--shell-peek` 로 소스를 읽어 확인한 값입니다 |
...
디스크가 250GB 도 안 나오면 이 길은 접고, 다음 주 06 재실행
