...
⚠️ **`03f` · `03g` · `03h` 는 여기 없습니다.** 채택되지 않았거나(03f 축 닫힘,
03g 헛알림 +1.8%p) 아직 결과가 안 나온 실험이라 main 에 안 올렸습니다.
**결론은 남아 있습니다** — [`docs/results/STEP14_1단계_백본_판A_실측.md`](../docs/results/)
와 `STEP15_털가중샘플러_실측.md`. 다시 돌릴 일이 생기면 작업 브랜치에 있습니다.
